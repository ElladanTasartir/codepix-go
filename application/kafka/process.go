...
import (
	...
	"github.com/ElladanTasartir/codepixgo/application/factory"
	appmodel "github.com/ElladanTasartir/codepixgo/application/model"
...
func (k *KafkaProcessor) processMessage(msg *ckafka.Message) {
	...
	transactionConfirmatonTopic := "transaction_confirmation"

	switch topic := *msg.TopicPartition.Topic; topic {
	case transactionsTopic:
		k.processTransaction(msg)
	case transactionConfirmatonTopic:
		k.processTransactionConfirmation(msg)
	default:
		fmt.Println("not a vald topic", string(msg.Value))
	}
}
